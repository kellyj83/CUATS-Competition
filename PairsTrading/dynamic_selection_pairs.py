...
class PairsTradingAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.long_targets2 = [PortfolioTarget(self.symbol3, 0.9), PortfolioTarget(self.symbol4, -0.9)]
        self.short_targets2 = [PortfolioTarget(self.symbol3, -0.9), PortfolioTarget(self.symbol4, 0.9)]
...
#
        ...
        if not self.is_invested and not self.is_invested2:
            
            if abs(z_score) > abs(z_score2):
